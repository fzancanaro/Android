...
/**
 * Created by flaviazancanaro on 22/5/17.
 * To custumize the display, I need to create my own custom adapter classes and XML layouts.
 * I'll then wirete a bit of code that receives the data objects from the adpter, and displays it
 * in views that are part of the layout.
 */

public class MainActivitySwimming extends AppCompatActivity {


    private static final int SIGNIN_REQUEST = 1001;
    public static final String MY_GLOBAL_PREFS = "my_global_prefs";
    private static final String TAG = "MainActivitySwimming";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_swimming);
...
//      Code to manage sliding navigation drawer
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(MainActivitySwimming.this, "You chose " + category,
